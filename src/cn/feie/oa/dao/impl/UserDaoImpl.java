...
public class UserDaoImpl extends JdbcDaoSupport implements UserDao {
	...
	@Override
	public User getParentById(int uid) {
		return null;
	}
	@Override
	public User getUserByDid(int did) {
		@SuppressWarnings("unchecked")
		User user = this.getJdbcTemplate().queryForObject("SELECT u.* FROM where pid = ?",new RowMapper() {
	...
	@Override
	public List<User> getUserByPid(Integer parentid) {
		@SuppressWarnings("unchecked")
		List<User> user = this.getJdbcTemplate().query("SELECT u.*,d.dname FROM user u LEFT JOIN dept d ON u.did=d.did where uid = ?",new RowMapper<User>() {
