...
public class PostDaoImpl extends JdbcDaoSupport implements PostDao {
	...
	public void addPost(Post post) {
		this.getJdbcTemplate().update("INSERT INTO post(pname,description,parentid) VALUES(?,?,?)",post.getPname(),post.getDescription(),post.getParentid());
	}
	@Override
	...
	public void updatePost(Post post) {
		this.getJdbcTemplate().update("update post set pname = ?,description = ?,parentid = ? where pid = ?",post.getPname(),post.getDescription(),post.getParentid(),post.getPid());
	}
	@Override
